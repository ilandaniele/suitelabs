...
{{/unless}}
	...
	<div class="login-register-register-form-controls-group">
		<label class="login-register-register-form-label">
			...
			{{translate 'Please do not send any marketing communications to me. I do not want to learn about exclusive deals, special pricing or promotions from $(0).' siteName}}
		</label>
	</div>
