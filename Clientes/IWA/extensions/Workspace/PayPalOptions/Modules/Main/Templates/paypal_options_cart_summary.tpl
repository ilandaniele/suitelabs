...
<div class="cart-summary">
	<div class="cart-summary-container">
		...
		{{#if isPriceEnabled}}
			...
			{{#if showDiscountTotal}}
				<div class="cart-summary-discount-applied">
					<p class="cart-summary-grid-float">
						<span class="cart-summary-amount-discount-total">
							{{translate '-$(0)' summary.discounttotal_formatted}}
						</span>
							{{translate 'Discount'}}
					</p>
				</div>
				<div class="cart-summary-discount-applied">
					<p class="cart-summary-grid-float">
						<span class="cart-summary-amount-discount-total">
							{{summary.discountedsubtotal_formatted}}
						</span>
							{{translate 'Subtotal'}}
					</p>
				</div>
			...
			{{#unless areAllItemsPickupable}}
									...
									{{#if isZipCodeRequire}}
										<div data-validation="control-group">
											...
											<div data-validation="control">
												<input type="tel" pattern="[0-9]*" inputmode="numeric" name="zip" id="zip" class="cart-summary-zip-code" value="{{shippingZipCode}}" />
											</div>
										</div>
									{{/if}}
				...
				{{else}}
					<div class="cart-summary-shipping-cost-applied">
						...
						<p class="cart-summary-grid-float {{#unless isLoggedIn}}hidden{{/unless}}">
					...
					<div class="cart-summary-total {{#unless isLoggedIn}}hidden{{/unless}}">
						<p class="cart-summary-grid-float">
		...
		{{#unless noShipAddress}}
		<div class="cart-summary-grid cart-summary-shipping-method-container">
			<div class="cart-summary-expander-head">
			...
			<div class="cart-summary-expander-body {{#if noShipAddress}}collapse{{/if}}" role="form" id="shipping-method-container" aria-expanded="false">
	...
	{{#if showActions}}
		<div class="cart-summary-button-container">
			...
			{{#if showPaypalButton}}
				<div data-view="PayPalOptions.Messaging"></div>
			{{/if}}
