	...
	<div class="order-wizard-cart-summary-body">
		...
		{{#if showDiscount}}
			<div class="order-wizard-cart-summary-discount-applied">
				<p class="order-wizard-cart-summary-grid-float">
					<span class="order-wizard-cart-summary-discount-total">
						{{translate '-$(0)' model.summary.discounttotal_formatted}}
					</span>
					{{translate 'Discount'}}
				</p>
			</div>
			<div class="order-wizard-cart-summary-discount-applied">
				<p class="order-wizard-cart-summary-grid-float">
					<span class="order-wizard-cart-summary-discount-total">
						{{model.summary.discountedsubtotal_formatted}}
					</span>
					{{translate 'Subtotal'}}
				</p>
			</div>
		...
		<div class="order-wizard-cart-summary-shipping-cost-applied {{#if isShippingAddressPage}} hidden {{/if}}">
		...
		<div class="order-wizard-cart-summary-total {{#if confirmationStep}}double-border{{/if}}" {{#if isShippingAddressPage}} hidden {{/if}}>
			<p class="order-wizard-cart-summary-grid-float">
				<span class="order-wizard-cart-summary-grid-right" >
