        ...
        getRecordValues: function(record) {
            ...
            if (this.isPickupInStoreEnabled) {
                ...
                if (map_result.allowstorepickup) {
                    ...
                    const nextpickupcutofftime = record.getValue('nextpickupcutofftime');

                    const next_pickup_cut_off_time_date =
                        nextpickupcutofftime &&
                        nextpickupcutofftime !== ' ' &&
                        nlapiStringToDate(nextpickupcutofftime);

                    if (next_pickup_cut_off_time_date) {
                        map_result.nextpickupcutofftime = next_pickup_cut_off_time_date.getDay();
