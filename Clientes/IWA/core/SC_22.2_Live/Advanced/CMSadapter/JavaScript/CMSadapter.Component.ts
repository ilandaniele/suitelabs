                ...
                function(e) {
                    const message =
                        ...
                        Utils.translate(
                            ...
                            cct.instanceId,
                            'Error when there is an unexpected error when installing the CCT with that instance Id'
                        );
                    return jQuery
                        .Deferred()
                    ...
                    return jQuery
                        ...
                        .reject(
                            this._createError(
                                ...
                                Utils.translate(
                                    'Invalid content type instance id: $(0), already exists',
                                    cctInstanceId,
                                    'Error when adding a CCT because already exists one with that instance id'
                                )
                            )
                        );
                }
                    ...
                    const cctGenerator = {
                        ...
                        cctErrorContextNotFound: this._createError(
                            ...
                            Utils.translate(
                                ...
                                cctInstanceId,
                                "Error when a CCT with that instance id doesn't have context"
                            )
                        )
                    };
                    ...
                    return jQuery
                        ...
                        .reject(
                            this._createError(
                                'ERR_INVALID_INSTANCE_ID',
                                Utils.translate(
                                    'Invalid content type instance id: $(0), does not exists',
                                    cctInstanceId,
                                    "Error when doesn't exist a CCT with that instance id"
                                )
                            )
                        );
                }
                        ...
                        .reject(
                            this._createError(
                                ...
                                Utils.translate(
                                    ...
                                    cctInstanceId,
                                    "Error when a CCT with that instance id doesn't exists"
                                )
                            )
                        );
                }
