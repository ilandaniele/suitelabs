...
define('QuoteToSalesOrder.ServiceController', [
...
], function(ServiceController, ModelsInit, _, QuoteToSalesOrderModel) {
    ...
    return ServiceController.extend({
        ...
        post: function() {
            ...
            order_info.confirmation = QuoteToSalesOrderModel.submit(false, _.extend(this.data,{salesorder_id: salesorder_id}));
