	...
	<div class="requestquote-wizard-module-comments">
		<div class="requestquote-wizard-module-comments-box requestquote-wizard-module-payment-method-box">
			...
			{{else}}
				...
				<input type="text" name="enter-rush-approved" class="list-header-view-accordion-body-select requestquote-wizard-half-box-write-field" data-action="enter-rush-approved" />
			{{/if}}
		</div>
	</div>
{{/if}}
