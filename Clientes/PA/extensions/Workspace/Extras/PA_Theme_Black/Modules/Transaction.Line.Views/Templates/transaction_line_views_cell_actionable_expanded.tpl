<tr id="{{lineId}}" data-item-id="{{itemId}}" data-type="order-item" {{#if showGeneralClass}} class="{{generalClass}}" {{/if}} >
	...
	{{#if showQuantityOnHand}}
		<td class="transaction-line-views-cell-actionable-expanded-table-middle quantity-on-hand">
			<div data-view="Item.QuantityOnHand.View"></div>
		</td>
	{{/if}}
	{{#if showItemQuality}}
		<td class="transaction-line-views-cell-actionable-expanded-table-middle quantity-on-hand">
			<div data-view="Item.Quality.View"></div>
		</td>
	{{/if}}
	{{#if showIncludeAdditional}}
		<td class="transaction-line-views-cell-actionable-expanded-table-middle quantity-on-hand">
			<div data-view="Include.Additional.View"></div>
		</td>
	{{/if}}
