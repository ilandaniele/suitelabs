<div class="product-reviews-form">
	{{#if isLoginRequiredAndIsNotLoggedIn}}
		<p class="pa-review-instruction">{{translate 'You need to be logged in to write a review, <a data-action="write-new-review" type="button">click here</a> to log in.'}}</p>
	{{else}}
