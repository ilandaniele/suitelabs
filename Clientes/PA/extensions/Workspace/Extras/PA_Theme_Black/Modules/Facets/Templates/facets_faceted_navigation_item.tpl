		...
		{{#if showHeading}}
			{{#if isUncollapsible}}
				<div class="facets-faceted-navigation-item-facet-group-expander">
					<p class="facets-faceted-navigation-item-facet-group-title">
						{{facetDisplayName}}
						{{#if showRemoveLink}}
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-facet-group-expander {{#if isCollapsed}}collapsed{{/if}}" data-toggle="collapse" data-target="#{{htmlId}}-wrapper" data-type="collapse" title="{{facetDisplayName}}">
					...
					<p class="facets-faceted-navigation-item-facet-group-title">{{facetDisplayName}}</p>
					{{#if showRemoveLink}}
						<a class="facets-faceted-navigation-item-filter-delete" href="{{removeLink}}">
							<i class="facets-faceted-navigation-item-filter-delete-icon"></i>
						</a>
					...
					{{#each displayValues}}
						<li>
							<a class="facets-faceted-navigation-item-facet-option {{#if isActive}}option-active{{/if}}" href="{{link}}" title="{{label}}">
								...
								{{#if isRating}}
									<div class="facet-views-star-rating-area">
										<div class="facet-views-star-rating-area-empty-content">
										...
										<div class="facet-views-star-rating-area-filled-content" style="width: {{ratingFilledValueForStarIcon}}%">
