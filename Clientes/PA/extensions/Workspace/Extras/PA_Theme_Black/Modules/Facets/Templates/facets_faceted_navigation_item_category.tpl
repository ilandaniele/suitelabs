...
<div class="facets-faceted-navigation-item-category-facet-group" data-type="rendered-facet" data-facet-id="{{facetId}}"  id="{{htmlId}}">
	{{#if isUncollapsible}}
		<div class="facets-faceted-navigation-item-category-facet-group-expander">
			<p class="facets-faceted-navigation-item-category-title">{{parentName}}</p>
		</div>
	{{else}}
		<a href="#" class="facets-faceted-navigation-item-category-facet-group-expander" data-toggle="collapse" data-target="#{{htmlId}}-wrapper" data-type="collapse" title="{{translate 'Category'}}">
			<i class="facets-faceted-navigation-item-category-facet-group-expander-icon"></i>
			<p class="facets-faceted-navigation-item-category-title">{{parentName}}</p>
		</a>
	{{/if}}

	<div class="{{#if isCollapsed}} collapse {{else}} collapse in {{/if}} facets-faceted-navigation-item-category-facet-group-wrapper" id="{{htmlId}}-wrapper">
