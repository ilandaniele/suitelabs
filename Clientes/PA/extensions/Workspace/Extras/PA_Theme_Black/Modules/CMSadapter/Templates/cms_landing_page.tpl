<div class="cms-landing-page-container">
...
<div class="cms-landing-page-container-fluid">
	<div class="cms-landing-page-row">
		<div class="cms-landing-page-row-full-col">
			<div data-cms-area="cms-landing-page-additonal-block-path1" data-cms-area-filters="path"></div>
		</div>
	</div>
</div>
