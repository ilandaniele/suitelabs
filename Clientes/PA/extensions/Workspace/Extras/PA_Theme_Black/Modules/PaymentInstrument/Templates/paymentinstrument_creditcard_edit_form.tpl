<fieldset class="paymentinstrument-creditcard-edit-form">
	...
	<div class="paymentinstrument-creditcard-edit-form">
		...
		<p id="not-supported" class="hidden" data-validation-error="block">Credit card is not supported</p>
	</div>
	...
	<div class="paymentinstrument-creditcard-edit-form" data-input="ccname" data-validation="control-group">
		...
		<div class="paymentinstrument-creditcard-edit-form-controls" data-validation="control">
			<input type="text" class="paymentinstrument-creditcard-edit-form-input" id="ccname" name="ccname" maxlength="26" value="{{ccname}}">
		</div>
	</div>
