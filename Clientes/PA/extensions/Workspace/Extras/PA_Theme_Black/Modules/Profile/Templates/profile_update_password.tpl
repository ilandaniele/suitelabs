			...
			<fieldset>
				...
				<div class="profile-update-password-form-group" data-input="current_password" data-validation="control-group">
					...
					<div  class="profile-update-password-group-form-controls" data-validation="control">
						<input type="password" class="profile-update-password-form-group-input" id="current_password" name="current_password" value="" maxlength="20">
					</div>
				</div>
				...
				<div class="profile-update-password-form-group" data-input="password" data-validation="control-group">
					...
					<div  class="profile-update-password-group-form-controls" data-validation="control">
						<input type="password" class="profile-update-password-form-group-input" id="password" name="password" value="" maxlength="20">
					</div>
				</div>
				...
				<div class="profile-update-password-form-group" data-input="confirm_password" data-validation="control-group">
					...
					<div  class="profile-update-password-group-form-controls" data-validation="control">
						<input type="password" class="profile-update-password-form-group-input" id="confirm_password" name="confirm_password" value="" maxlength="20">
					</div>
				</div>
			</fieldset>
