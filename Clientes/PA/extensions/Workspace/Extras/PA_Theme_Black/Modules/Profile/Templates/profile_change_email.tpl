			...
			<fieldset>
				...
				<div class="profile-change-email-form-group" data-input="new_email" data-validation="control-group">
					...
					<div  class="profile-change-email-group-form-controls" data-validation="control">
						<input type="email" class="profile-change-email-form-group-input" id="new_email" name="new_email" value="" placeholder="{{translate 'your@email.com'}}" maxlength="30">
					</div>
				</div>
				...
				<div class="profile-change-email-form-group" data-input="confirm_email" data-validation="control-group">
					...
					<div  class="profile-change-email-group-form-controls" data-validation="control">
						<input type="email" class="profile-change-email-form-group-input" id="confirm_email" name="confirm_email" value="" placeholder="{{translate 'your@email.com'}}" maxlength="30">
					</div>
				</div>
				...
				<div class="profile-change-email-form-group" data-input="current_email" data-validation="control-group">
					...
					<div  class="profile-change-email-group-form-controls" data-validation="control">
						<input type="password" class="profile-change-email-form-group-input" id="current_password" name="current_password" value="" maxlength="20">
					</div>
				</div>
			</fieldset>
