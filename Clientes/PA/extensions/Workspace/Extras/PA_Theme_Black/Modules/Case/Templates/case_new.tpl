...
<section class="case-new">
	...
	<form action="#" class="case-new-form" novalidate>
		...
		<div class="case-new-form-controls-group" data-validation="control-group">
			<label class="case-new-form-label" for="custevent_case_sales_order">
				{{translate 'Sales Order#'}}
			</label>

			<div class="case-new-form-controls" data-validation="control">
				<select name="custevent_case_sales_order" id="custevent_case_sales_order" class="case-new-form-case-category">
					{{#each sales_orders}}
						<option value="{{internalid}}">
							{{translate 'Sales Order#'}} {{tranid}}
						</option>
					{{/each}}
				</select>
			</div>
