	...
	<div class="case-detail-header-information">
		<div class="case-detail-header-row">
			<div class="case-detail-header-col-left">
				...
				<p>{{translate '<span class="case-detail-label-last-message-date">Sales Order info: </span> <span class="case-detail-value-last-message-date">$(0)</span>' model.sales_order.name}}</p>
			</div>
