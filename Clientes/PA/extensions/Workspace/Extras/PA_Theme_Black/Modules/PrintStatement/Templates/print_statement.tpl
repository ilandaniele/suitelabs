	...
	<form class="print-statement-form">
		...
		<div class="print-statement-form-group" data-validation="control-group">
			...
			<div  class="print-statement-form-controls" data-validation="control">
				<input type="date" data-format="yyyy-mm-dd" id="statementDate" name="statementDate" class="print-statement-form-group-input" autocomplete="off" data-todayhighlight="true" placeholder="YYYY-MM-DD"/>
		...
		<div class="print-statement-form-group" data-validation="control-group">
			...
			<div  class="print-statement-form-controls" data-validation="control">
				<input type="date" data-format="yyyy-mm-dd" id="startDate" name="startDate" class="print-statement-form-group-input" autocomplete="off" data-todayhighlight="true" placeholder="YYYY-MM-DD"/>
				<i class="print-statement-form-input-icon"></i>
			</div>
		</div>
