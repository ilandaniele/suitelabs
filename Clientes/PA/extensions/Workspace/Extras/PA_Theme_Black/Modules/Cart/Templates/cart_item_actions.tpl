{{#unless isRetailDeliveryItem}}
	<div class="cart-item-actions-links">
		...
		<button class="cart-item-actions-item-list-actionable-edit-content-container-toggle-button" type="button" data-toggle="dropdown">
			<span class="caret"></span>
		</button>
		{{/if}}

		<ul class="cart-item-actions-item-list-actionable-edit-content-container">
			<li>
