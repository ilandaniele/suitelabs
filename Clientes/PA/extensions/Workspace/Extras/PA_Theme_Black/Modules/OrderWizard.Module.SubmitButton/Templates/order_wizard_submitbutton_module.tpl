...
<div class="{{wrapperClass}}">
	{{/if}}
	<button class="order-wizard-submitbutton-module-button" {{#if isInProgress}}disabled{{/if}}
		data-action="submit-step">{{continueButtonLabel}}</button>
	<div class="order-wizard-submitbutton-module-edit-cart-link-container">
		<a href="#" class="order-wizard-submitbutton-module-edit-cart-link" data-action="edit-module"
			data-touchpoint="viewcart" {{#if isInProgress}} disabled{{/if}}>
			{{translate 'Edit Cart'}}
		</a>
	</div>
	{{#if showWrapper}}
