<div class="address-edit-fields">
	...
	<div class="address-edit-fields-group" data-input="fullname" data-validation="control-group">
		...
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
			<input autocomplete="addrexx"  type="text" class="address-edit-fields-group-input" id="{{manage}}fullname" name="fullname" value="{{fullName}}">
		</div>
	</div>
	{{#if showCompanyField}}
	...
	<div class="address-edit-fields-group" data-input="addr1" data-validation="control-group">
		...
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
			<input autocomplete="addrexx" type="text" class="address-edit-fields-group-input" id="{{manage}}addr1" name="addr1" value="{{addressLine1}}">
			<p class="address-edit-fields-input-help">{{translate 'Example: 1234 Main Street'}}</p>
		</div>
	</div>

	<div class="address-edit-fields-group address-edit-fields-group-big" data-input="addr2" data-validation="control-group">
		<label for="{{manage}}addr2">
			<p class="address-edit-fields-addr2-optional-label no-margin-bottom">{{translate '(optional)'}}</p>
			<p class="address-edit-fields-group-label no-margin-bottom">{{translate 'Address 2'}}</p>
		</label>
		<div data-validation="control">
			<input autocomplete="addrexx" type="text" class="address-edit-fields-group-input" id="{{manage}}addr2" name="addr2" value="{{addressLine2}}">
	...
	<div class="address-edit-fields-group" data-input="city" data-validation="control-group">
		...
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
			<input autocomplete="addrexx" type="text" class="address-edit-fields-group-input" id="{{manage}}city" name="city" value="{{city}}">
		</div>
	</div>
	...
	<div class="address-edit-fields-group" data-input="zip" {{#if isZipOptional}} style="display: none;" {{/if}} data-validation="control-group">
		...
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
			<input autocomplete="addrexx" type="text" class="address-edit-fields-group-input-zip" id="{{manage}}zip" name="zip" value="{{zip}}" data-type="zip">
	...
	<div class="address-edit-fields-group"  data-input="phone" data-validation="control-group">
		...
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
			<input autocomplete="addrexx" type="tel" class="address-edit-fields-group-input" id="{{manage}}phone" name="phone" value="{{phone}}" data-action="inputphone">
