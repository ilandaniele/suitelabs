...
<div class="order-history-packages-products-conatiner">
	<h2 class="order-history-packages-products-heading">Shipped Items</h2>
	<div class="order-history-packages-acordion-divider">
		<div class="order-history-packages-accordion-head">
			<a class="order-history-details-accordion-head-toggle-secondary collapsed" data-toggle="collapse" data-target="#{{targetId}}" aria-expanded="true" aria-controls="unfulfilled-items">
				<span class="order-history-packages-accordion-head-toggle-status">Ship</span>
				<span class="order-history-packages-accordion-head-toggle-auxiliar-text">
				{{#if isPackageInStore}}
					{{translate ' at :'}}
				{{else}}
		...
		<div class="order-history-packages-accordion-body collapse" id="{{targetId}}" role="tabpanel" data-target="#{{targetId}}">
			<div class="order-history-packages-accordion-container" data-content="order-items-body">
			{{#if isPackageInStore}}
				<div data-view="Address.StoreLocationInfo"></div>
				{{#if showGetDirectionButton}}
				...
				{{/if}}
			{{else}}
				<div class="order-history-details-shiping-info-ship-address-col">
					<h5 class="order-history-details-shiping-info-ship-address-text">Shipping Address</h5>
					<div data-view="Shipping.Address.View"></div>
				</div>
				<div class="order-history-details-shiping-info-delivery-method-col">
					<h5 class="order-history-details-shiping-info-delivery-method-text">Delivery Method</h5>
					<div class="order-history-details-shiping-info-delivery-method-name">
	...
	<div class="order-history-details-accordion-divider">
		<div class="order-history-packages-accordion-head">
			{{#ifEquals packageStatus 'Shipped'}}
			<a class="order-history-details-accordion-head-toggle-secondary {{initiallyCollapsedArrow}}" data-toggle="collapse" data-target="#order-products-info" aria-expanded="true" aria-controls="unfulfilled-items">
				Products Shipped
				<i class="order-history-details-accordion-toggle-icon-secondary"></i>
			</a>
			{{else}}
			<a class="order-history-details-accordion-head-toggle-secondary {{initiallyCollapsedArrow}}" data-toggle="collapse" data-target="#order-products-info" aria-expanded="true" aria-controls="unfulfilled-items">
				Products Pending Shipment
				<i class="order-history-details-accordion-toggle-icon-secondary"></i>
			</a>
			{{/ifEquals}}
		</div>
		<div class="order-history-packages-accordion-body collapse {{initiallyCollapsed}}" id="order-products-info" role="tabpanel">
			<div class="order-history-products-accordion-container" data-content="order-items-body">
				{{#ifEquals packageStatus 'Shipped'}}
				<div class="order-history-packages-shipping-info-wrapper">
					{{#unless isPackageInStore}}
					<div class="order-history-packages-header-col">
						<span class="order-history-packages-shipped-status-label">{{translate 'Status: '}}</span> 
						<span class="order-history-packages-shipped-status-value">{{packageStatus}}</span>
