...
define('CardHolderAuthentication.Utils', ['Sanitize', 'underscore'], function (Sanitize, _) {
    ...
    return {
        ...
        // @method getEncodedAction
        // @param {String} url
        // @return {String}
        getEncodedAction: function(url) {
            return url === decodeURIComponent(url) ? Sanitize.encodeForURL(url) : url;
        }
    };
});
