...
import NotificationsOrderOutOfStockItems = require('./Notifications.Order.OutOfStockItems.View');
...
const NotificationsOrderView: any = BackboneView.extend({
    ...
    childViews: {
        ...
        'OutOfStockItems.Notifications': function() {
            return new NotificationsOrderOutOfStockItems(this.model);
        }
    },
