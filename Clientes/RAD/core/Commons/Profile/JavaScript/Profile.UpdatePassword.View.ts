...
const ProfileUpdatePasswordView: any = BackboneView.extend({
    ...
    resetForm: function(event) {
        ...
        // setting a value for the attributes so 'unset' will triggers
        // the 'change' event and the validationModel is updated
        this.model.set('current_password', '');
        this.model.set('password', '');
        this.model.set('confirm_password', '');
