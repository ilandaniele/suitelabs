...
define('Profile.Model', [
    ...
    'Utils'
], function(SCModel, ModelsInit, SiteSettings, PaymentMethodModel, PaymentMethodModelACH, Utils) {
    return SCModel.extend({
        ...
        get: function() {
            ...
            if (ModelsInit.session.isLoggedIn2() && this.isSecure) {
                ...
                if (SiteSettings.isACHEnabled()) {
                    profile.paymentmethodsach = PaymentMethodModelACH.list();
                }
