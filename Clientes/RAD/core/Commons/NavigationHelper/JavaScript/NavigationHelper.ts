...
const NavigationHelper: any = {
    mountToApp: function(application) {
        ...
        _.extend(Layout, {
            ...
            // @property {PluginContainer} keyDown plugin container that handles the global keyDown event
            keyDown: new PluginContainer(),
            ...
            // @method executeTouchStart execute all keyDown plugins
            // @param {jQuery.Event} e
            executeKeyDown: function(e) {
                this.keyDown.executeAll(e);
            },
        ...
        _.extend(Layout.events, {
            ...
            'keydown a:not([data-navigation="ignore-click"])': 'executeKeyDown',
