    ...
    return SCModel.extend({
        ...
        get: function() {
            ...
            if (settings_cache) {
                ...
                settings.isACHEnabled = this.isACHEnabled();
        ...
        // @method isACHEnabled. @returns {Boolean}
        isACHEnabled: function() {
            const checkoutCompany = Configuration.get('checkoutApp.isAchEnabledInCheckout'),
                checkoutIndividual = Configuration.get('checkoutApp.isACHEnabledForAllCustomers'),
                makePayment = Configuration.get('paymentInstrumentACHEnabled');

            return makePayment || checkoutIndividual || checkoutCompany;
        }
    });
});
