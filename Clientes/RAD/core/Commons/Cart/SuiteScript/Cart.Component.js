    ...
    const componentConstructor = function(extensionName) {
        _.extend(
            ...
            ICartComponent.extend({
                ...
                removeAllLines: function removeAllLines() {
                    const deferred = jQuery.Deferred();
                    try {
        ...
        const innerToOuterMap = [
            ...
            // @event beforeRemoveAllLines Cancelable event triggered before all lines are removed from the cart. @public @extlayer
            {
                inner: 'before:LiveOrder.removeAllLines',
                outer: 'beforeRemoveAllLines',
                normalize: null
            },
            // @event afterRemoveAllLines Cancelable event triggered after all lines are removed from the cart. @public @extlayer
            {
                inner: 'after:LiveOrder.removeAllLines',
                outer: 'afterRemoveAllLines',
                normalize: null
            },
