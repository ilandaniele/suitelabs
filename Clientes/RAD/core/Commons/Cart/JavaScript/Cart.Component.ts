...
export = function CartComponentGenerator(application) {
    ...
    const innerToOuterMap = [
        ...
        // @event removeAllLines Triggered before all lines are removed from order @public @extlayer
        {
            inner: 'before:LiveOrder.removeAllLines',
            outer: 'beforeRemoveAllLines',
            normalize: null
        },
        // @event removeAllLines Triggered after all lines are removed from order @public @extlayer
        { inner: 'after:LiveOrder.removeAllLines', outer: 'afterRemoveAllLines', normalize: null },
