...
export = BackboneView.extend({
    ...
    events: {
        ...
        'click [data-action="clear-cart"]': 'clearCart'
    },
    ...
    clearCart: function(e) {
        ...
        const deleteConfirmationView = new GlobalViewsConfirmationView({
            callBack: () => {
                this.model.removeAllLines().done(() => {
                    this.render();
                });
            },
            title: Utils.translate('Clear Cart'),
        ...
        this.application.getLayout().showInModal(deleteConfirmationView);
    },
