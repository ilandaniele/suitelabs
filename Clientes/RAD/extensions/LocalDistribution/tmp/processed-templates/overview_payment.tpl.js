define('overview_payment.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "		<div data-view=\"CreditCard.View\"></div>\n		<div class=\"overview-payment-card-button-edit-container\">\n			<a class=\"overview-payment-card-button-edit button-secondary button-medium\" href=\"/creditcards/"
    + alias3(((helper = (helper = compilerNameLookup(helpers,"creditCardInternalid") || (depth0 != null ? compilerNameLookup(depth0,"creditCardInternalid") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"creditCardInternalid","hash":{},"data":data,"loc":{"start":{"line":10,"column":98},"end":{"line":10,"column":122}}}) : helper)))
    + "\" data-toggle=\"show-in-modal\">"
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"Edit",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":10,"column":152},"end":{"line":10,"column":172}}}))
    + "</a>\n		</div>\n";
  ...
  return "		<div class=\"overview-payment-card-content\">\n			<p>"
    ...
    + "</p>\n		</div>\n		<a href=\"/creditcards/new\" class=\"overview-payment-card-button-edit button-secondary button-medium\" data-toggle=\"show-in-modal\">"
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"Add a Credit Card",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":16,"column":130},"end":{"line":16,"column":163}}}))
    + "</a>\n";
