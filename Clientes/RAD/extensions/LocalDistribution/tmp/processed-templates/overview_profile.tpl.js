define('overview_profile.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<article class=\"overview-profile\">\n	<div class=\"overview-profile-header\">\n		<h4>"
    ...
    + "</p>\n		</div>\n		<div class=\"overview-profile-card-button-edit-container\">\n			<a class=\"button-medium button-secondary overview-profile-card-button-edit\" href=\"/profileinformation\">"
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"Edit",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":15,"column":106},"end":{"line":15,"column":126}}}))
    + "</a>\n		</div>\n	</section>\n</article>\n\n\n\n\n";
},"useData":true}; var main = t.main; t.main = function(){ arguments[1] = arguments[1] || {}; var ctx = arguments[1]; ctx._extension_path = 'http://localhost:7777/tmp/extensions/AwaLabs/ReginaAndrewTheme/23.2.2/'; ctx._theme_path = 'http://localhost:7777/tmp/extensions/AwaLabs/ReginaAndrewTheme/23.2.2/'; return main.apply(this, arguments); }; var template = Handlebars.template(t); template.Name = 'overview_profile'; return template;});