define('overview_shipping.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "		<div data-view=\"Address.Details\" class=\"overview-shipping-card-content\"></div>\n		<div class=\"overview-shipping-card-button-edit-container\">\n			<a class=\"overview-shipping-card-button-edit button-secondary button-medium\" href=\"/addressbook/"
    + alias3(((helper = (helper = compilerNameLookup(helpers,"shippingAddressInternalid") || (depth0 != null ? compilerNameLookup(depth0,"shippingAddressInternalid") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"shippingAddressInternalid","hash":{},"data":data,"loc":{"start":{"line":9,"column":99},"end":{"line":9,"column":128}}}) : helper)))
    + "\" data-toggle=\"show-in-modal\">"
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"Edit",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":9,"column":158},"end":{"line":9,"column":178}}}))
    + "</a>\n		</div>\n";
  ...
  return "		<div class=\"overview-shipping-card-content\">\n			<p>"
    ...
    + "</p>\n		</div>\n		<a href=\"/addressbook/new\" class=\"overview-shipping-card-button-edit button-secondary button-medium\" data-toggle=\"show-in-modal\">"
    + alias3((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"Create New Address",{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":15,"column":131},"end":{"line":15,"column":165}}}))
    + "</a>\n";
