<div class="order-wizard-cart-summary-container">
	...
	<div class="order-wizard-cart-summary-body">
			...
			<p class="order-wizard-cart-summary-grid-float">
				...
				<span class="order-wizard-cart-summary-subtotal-label">
					{{#if itemCountGreaterThan1}}
						{{translate '<span class="order-wizard-cart-summary-item-quantity-subtotal" data-type="cart-summary-subtotal-count">$(0) RAD items</span>' itemCount}}
					{{else}}
						{{translate '<span class="order-wizard-cart-summary-item-quantity-subtotal" data-type="cart-summary-subtotal-count">$(0) RAD item</span>' itemCount}}
					{{/if}}
				</span>
			</p>
		</div>
        ...
        {{/if}}
        <p class="cart-summary-subtotal-legend">{{translate 'Subtotal does not include shipping or tax'}}</p>
        <br>
