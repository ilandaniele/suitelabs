<div class="global-views-star-rating" itemprop="aggregateRating" data-validation="control-group">
	...
	<div class="global-views-star-rating-container">
		...
		<div {{#if name}}id="{{name}}"{{/if}} class="global-views-star-rating-area {{#if isReviewMode}}global-views-star-rating-area-review-mode{{/if}}" data-toggle='rater' data-validation="control" data-name="{{name}}" data-max="{{maxValue}}" data-value="{{value}}">
