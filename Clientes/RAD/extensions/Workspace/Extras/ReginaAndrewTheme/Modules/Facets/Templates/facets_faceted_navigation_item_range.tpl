{{#if showFacet}}
<div class="facets-faceted-navigation-item-range-facet-group" data-type="rendered-facet" data-facet-id="{{facetId}}">
	{{#if showHeading}}
	{{#if isUncollapsible}}
	...
	{{else}}
	<a href="#"
		class="facets-faceted-navigation-item-range-facet-group-expander collapsed {{#if isCollapsed}}collapsed{{/if}}"
		data-toggle="collapse" data-target="#{{htmlId}}" data-type="collapse" title="{{facetDisplayName}}">
	...
	<div class="facets-faceted-navigation-item-range-facet-group-wrapper">
		...
		<div class="facets-faceted-navigation-item-range-facet-group-wrapper {{#if isCollapsed}} collapse {{else}} in {{/if}}"
			...
			<div class="facets-faceted-navigation-item-range-slider" data-toggle="slider" data-facet-id="{{facetId}}"
				data-min="{{rangeMin}}" data-max="{{rangeMax}}" data-low="{{rangeFrom}}" data-high="{{rangeTo}}">
