		...
		<div class="facets-item-cell-list-image-wrapper">
			...
			{{#if itemIsNavigable}}
				<a class="facets-item-cell-list-anchor" href='{{url}}'>
					<img class="facets-item-cell-list-image {{#if hoverImage}}facets-item-cell-has-hover-image{{/if}}" src="{{resizeImage thumbnail.url 'thumbnail'}}" alt="{{thumbnail.altimagetext}}" itemprop="image">
					{{#if hoverImage}}
