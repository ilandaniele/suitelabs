            ...
            {{#if isPriceRange}}
                <span class="product-views-price-range" itemprop="offers">
                    ...
                    <span class="product-views-price-lead" data-role="product-view-price-lead">
                        {{translate
                                '<span itemprop="lowPrice" data-rate="$(0)" >$(1)</span> to <span itemprop="highPrice" data-rate="$(2)">$(3)</span>'
                    ...
                    <link itemprop="availability"
                          href="{{#if isPurchasable}}{{#if isInStock}}https://schema.org/InStock{{else}}{{#if
                                  backOrderPreOrder}}https://schema.org/PreOrder{{else}}https://schema.org/InStock{{/if}}{{/if}}{{else}}https://schema.org/OutOfStock{{/if}}"/>
                </span>
            {{else}}
