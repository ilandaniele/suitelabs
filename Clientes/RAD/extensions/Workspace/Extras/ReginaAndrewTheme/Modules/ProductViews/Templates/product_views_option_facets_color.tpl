					...
					<div class="product-views-option-facets-color-picker-small">
						<label class="product-views-option-facets-color-picker-label">
								<a class="product-views-option-facets-color-picker-anchor" href="{{url}}">
									{{#if isColorTile}}
										<span data-toggle="tooltip" data-placement="top" title="{{label}}" data-label="label-{{../cartOptionId}}" value="{{internalId}}" class="product-views-option-facets-color-picker-box {{#if isLightColor}}product-views-option-facets-color-picker-box-white-border{{/if}}"
