<div class="cart-detailed">
	...
	<div class="cart-detailed-body">
		<section class="{{#if showLines}}cart-detailed-left {{else}}cart-detailed-empty{{/if}}">
            ...
            <p class="top-leyend">{{translate 'Note: You can still add to this order by placing items into the cart!'}}</p>

			{{#if showLines}}
                {{#if showProceedToCheckoutButton}}
                ...
                {{else}}
                    <div class="cart-detailed-proceed-to-checkout-container cart-summary-message cart-summary-msg-description"
                         data-action="sticky">
	...
	<div class="cart-detailed-footer">
        {{#if isTrade}}
            <div data-view="CartToQuote.MarketWizard.View" class="cart-detailed-savedforlater"></div>
        {{/if}}
