...
<div class="cart-item-summary-item-list-actionable-amount">
    ...
    {{#if useRetailPrices}}
        <span class="cart-item-summary-amount-value">{{ line.retailTotalFormatted}}</span>
    {{else}}
        <span class="cart-item-summary-amount-value">{{ line.total_formatted}}</span>
    {{/if}}
	{{#if showComparePrice}}
        {{#if useRetailPrices}}
            <small class="muted cart-item-summary-item-view-old-price">{{ line.retailAmountFormatted}}</small>
        {{else}}
...
<div class="cart-item-summary-item-list-actionable-amount">
	<span class="cart-item-summary-item-list-actionable-amount-label">{{translate 'Available:'}} </span>
        <span class="cart-item-summary-amount-value">{{line.quantityAvailable}}</span>
</div>
<div class="cart-item-summary-item-list-actionable-amount">
	<span class="cart-item-summary-item-list-actionable-amount-label">{{translate 'Expected Ship Date:'}} </span>
        <span class="cart-item-summary-amount-value">{{line.expectedShippingDate}}</span>
</div>
